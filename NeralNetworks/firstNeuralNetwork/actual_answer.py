...
class NeuralNetworkAnswer(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        print("Hidden Error Term ",hidden_error_term," Shape ",hidden_error_term.shape," Input transpose ",X.T," Shape ",(X.T).shape," Multiplication ",hidden_error_term*X.T," Shape ",(hidden_error_term*X.T).shape)
